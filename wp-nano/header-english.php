...
<head>
  ...
  <?php if ( is_page('en') ): ?>
  <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/css/top.css?v2" media="all">
  <?php elseif ( is_page(array('en02','en03','en04','en05')) ): ?>
  <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/css/top.css?v2" media="all">
...
<?php endif; ?>
    ...
    <div class="hd__flex flex jc-between align-items">
      ...
      <div class="hd__right pc flex jc-end">
        ...
        <p class="hd__en pc font-en"><a href="/<?php switch_lang($post->post_name); ?>">日本語</a></p>
      </div>
      <div class="hd__right sp">
        ...
        <div class="g-nav__bg">
          ...
          <div class="g-nav__bg--flex flex jc-center">
            <p class="g-nav__bg--btn english__btn font-en"><a href="/<?php switch_lang($post->post_name); ?>">日本語</a></p>
          </div>
        </div>
      </div>
    </div>
